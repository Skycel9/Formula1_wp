# Formula 1 - API via Plugin Wordpress
...
1. Télécharger le fichier d'export disponible dans le dossier [/dist](https://github.com/Skycel9/Formula1_wp/tree/master/dist)
